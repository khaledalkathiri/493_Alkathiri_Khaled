...
{
	public static final String TAG = Farmer.class.getName();
	...
	{
		dimension.set(1, 1);
		regHead = Assets.instance.farmer.farmer;
	...
	public void update (float deltaTime)
	{
		...
		if (timeLeftFeatherPowerup > 0) 
		{
			...
			position.x += 2 * velocity.x * deltaTime;
			if (timeLeftFeatherPowerup < 0) 
			{
				//disable power-up
				timeLeftFeatherPowerup = 0;
	...
	public void render (SpriteBatch batch) 
	{
		...
		// Draw image
		reg = regHead;
		batch.draw(reg.getTexture(), position.x, position.y - 0.3f, origin.x,
