...
public class WorldRenderer implements Disposable
{
	...
	private void renderGuiScore (SpriteBatch batch)
	{
		...
		batch.draw(Assets.instance.dates.dates, x, y, offsetX,offsetY, 100, 100, 0.35f, -0.35f, 0);
	...
	private void renderGuiExtraLive (SpriteBatch batch) 
	{
		...
		for (int i = 0; i < Constants.LIVES_START; i++) 
		{
			...
			batch.draw(Assets.instance.farmer.farmer,x + i * 50, y, 50, 50, 120, 100, 0.35f, -0.35f, 0);
		...
		if (worldController.lives>= 0 &&worldController.livesVisual>worldController.lives) 
		{
			...
			batch.draw(Assets.instance.farmer.farmer,  x + i * 50, y, 50, 50, 120, 100, alphaScale,
					-alphaScale, alphaRotate);
			batch.setColor(1, 1, 1, 1);
		}
	}
	...
	private void renderGuiFeatherPowerup (SpriteBatch batch)
	{
		float x = -15;
		float y = 30;
		float timeLeftFeatherPowerup = worldController.level.farmer.timeLeftFeatherPowerup;
